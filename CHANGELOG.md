...
#### 3.0.0-beta.2 *May 2023*
 ...
 - Several Breaking Changes. See the [migration guide](https://github.com/Sub6Resources/flutter_html_2/wiki/Migration-Guides#300)

 - **FIX**: start list items on a new line ([#1281](https://github.com/sub6resources/flutter_html_2/issues/1281)). ([496d1aa8](https://github.com/sub6resources/flutter_html_2/commit/496d1aa8e655891d2f597c5e4d7e92057801d815))
 - **FIX**: Add "display: Display.block" to table ([#1278](https://github.com/sub6resources/flutter_html_2/issues/1278)). ([6350f023](https://github.com/sub6resources/flutter_html_2/commit/6350f02354b7de601ce294123717e2051be97eee))
 - **FIX**: improve API for ExtensionContext and export marker.dart ([#1273](https://github.com/sub6resources/flutter_html_2/issues/1273)). ([27e33a95](https://github.com/sub6resources/flutter_html_2/commit/27e33a955e872d47306db9480f74f6da2e9a028a))
 - **FIX**: Cleaned up whitespace processing and added whitespace tests ([#1267](https://github.com/sub6resources/flutter_html_2/issues/1267)). ([cc00406b](https://github.com/sub6resources/flutter_html_2/commit/cc00406b1d0c115e5c66dd4bdfb40db32496f55f))
 - **FIX**: a tag should not style as link if href is not provided ([#1265](https://github.com/sub6resources/flutter_html_2/issues/1265)). ([d7247cb3](https://github.com/sub6resources/flutter_html_2/commit/d7247cb303c25d0011f85f9b2d3687924de3d83d))
 - **FEAT**: Update CssBoxWidget to handle rtl marker boxes ([#1270](https://github.com/sub6resources/flutter_html_2/issues/1270)). ([d7091990](https://github.com/sub6resources/flutter_html_2/commit/d7091990d193e892e2f782ac8d91fc0326aff4bc))
 - **FEAT**: support vertical-align in inline styles ([#1266](https://github.com/sub6resources/flutter_html_2/issues/1266)). ([fe896de5](https://github.com/sub6resources/flutter_html_2/commit/fe896de5ed8b79425bb33800a26fa4ac328057fe))
 - **FEAT**: Add WrapperExtension helper ([#1264](https://github.com/sub6resources/flutter_html_2/issues/1264)). ([2ffa1dda](https://github.com/sub6resources/flutter_html_2/commit/2ffa1ddabb3f2a660ab85c551255b89fe8a24ab5))
...
#### 3.0.0-beta.1 - *May 2023*
 ...
 - **FIX**: Aspect ratio exception when height is 0 ([#1222](https://github.com/sub6resources/flutter_html_2/issues/1222)). ([ed75f8fe](https://github.com/sub6resources/flutter_html_2/commit/ed75f8fef779e920ecc1f27719a4150a29e3ebee))
 - **FIX**: Fix issue with font scaling introduced in 3.0.0-alpha.6 ([#1173](https://github.com/sub6resources/flutter_html_2/issues/1173)). ([c75e0dfb](https://github.com/sub6resources/flutter_html_2/commit/c75e0dfb1be6cb79748f719487043d12bc330c60))
 - **FIX**: Fix various issues with list rendering. ([520ff3c3](https://github.com/sub6resources/flutter_html_2/commit/520ff3c326d5dc8f5a601022c2a32d58e2e83cbb))
 - **FIX**: Apply margins to <table> properly. ([7581ea79](https://github.com/sub6resources/flutter_html_2/commit/7581ea798744b2830affaaf75bbdff016b03f7af))
 - **FIX**: Use enum instead of const int internally in length.dart. ([9dc7f08c](https://github.com/sub6resources/flutter_html_2/commit/9dc7f08ca238ff6a93314be5de716ad4e3baebb8))
 - **FIX**: Change CSSBoxWidget to CssBoxWidget. ([a62449a7](https://github.com/sub6resources/flutter_html_2/commit/a62449a77c18701a0faf8ffd650f9c535b2d006c))
 - **FEAT**: Support mmultiscripts. ([#1175](https://github.com/sub6resources/flutter_html_2/issues/1175)). ([a999a300](https://github.com/sub6resources/flutter_html_2/commit/a999a30027eff0aabb2825ffdbe383f9affab7f6))
 - **FEAT**: Support mfenced. ([#1174](https://github.com/sub6resources/flutter_html_2/issues/1174)). ([9ca23084](https://github.com/sub6resources/flutter_html_2/commit/9ca230848beb15332f96294083ed4989831130d7))
 - **FEAT**: Upgrade list-style-type to CSS3. ([deb726ae](https://github.com/sub6resources/flutter_html_2/commit/deb726ae2776f45305026c0aa081d4a5b5a1c71d))
 - **FEAT**: Support mtable, mtd, mtr for draw matrix. ([#1164](https://github.com/sub6resources/flutter_html_2/issues/1164)). ([e99e2cc1](https://github.com/sub6resources/flutter_html_2/commit/e99e2cc1553ab17b4ceff08f784e99283b28dff4))
...
* **BREAKING** Full modularization using split packages; see our upgrade guide or use flutter_html_2_all 
...
* Fixed issue where `shrinkWrap` property would not constrain the widget to take up the space it needs
  * See the [Notes](https://github.com/Sub6Resources/flutter_html_2#notes) for an example usage with `shrinkWrap`
...
# [1.0.0]
* BREAKING CHANGES (see the [Migration Guide](https://github.com/Sub6Resources/flutter_html_2/wiki/1.0.0-Migration-Guide) for a full overview of breaking changes.):
...
* Fixes many many issues (see the list at [#122](https://github.com/Sub6Resources/flutter_html_2/pull/122))
* The following parameters of `Html` have been removed and should no longer be used (see the migration guide):
  ...
  * `imageProperties`
  * `showImages`
* The default text style now matches the app's Material `TextTheme.bodyText2` (Fixes [#18](https://github.com/Sub6Resources/flutter_html_2/issues/18)).
...
* Add support for `AssetImage`s using the `asset:` prefix ([#162](https://github.com/Sub6Resources/flutter_html_2/pull/162)).

## [0.11.0] - September 10, 2019:

* Make it so `width=100%` doesn't throw error. Fixes [#118](https://github.com/Sub6Resources/flutter_html_2/issues/118).
* You can now set width and/or height in `ImageProperties` to negative to ignore the `width` and/or `height` values from the html. Fixes [#97](https://github.com/Sub6Resources/flutter_html_2/issues/97)
* The `img` `alt` property now renders correctly when the image fails to load and with the correct style. Fixes [#96](https://github.com/Sub6Resources/flutter_html_2/issues/96)
* Add partial support for `sub` tag.
* Add new option: `shrinkToFit` ([#148](https://github.com/Sub6Resources/flutter_html_2/pull/148)). Fixes [#75](https://github.com/Sub6Resources/flutter_html_2/issues/75).
...
* Add `src` to the `onImageTap` callback ([#93](https://github.com/Sub6Resources/flutter_html_2/pull/93))

## [0.10.2] - June 19, 2019:

* Add `customTextAlign` property ([#112](https://github.com/Sub6Resources/flutter_html_2/pull/112))
* Use `tryParse` instead of `parse` for image width and height attributes so that `%` values are ignored safely. Fixes [#98](https://github.com/Sub6Resources/flutter_html_2/issues/98)

## [0.10.1] - May 20, 2019:

* Image properties and onImageTap for the richTextParser, plus some fixes ([#90](https://github.com/Sub6Resources/flutter_html_2/pull/90))
* Hotfix 1 (June 6, 2019): Fixes [#100](https://github.com/Sub6Resources/flutter_html_2/issues/100)
...
* Fixes extra padding issue ([#87](https://github.com/Sub6Resources/flutter_html_2/issues/87))
...
* Added custom textstyle and edgeinsets callback ([#72](https://github.com/Sub6Resources/flutter_html_2/pull/72))
* Update dependency versions ([#84](https://github.com/Sub6Resources/flutter_html_2/issues/84))
* Fixes [#82](https://github.com/Sub6Resources/flutter_html_2/issues/82) and [#86](https://github.com/Sub6Resources/flutter_html_2/issues/86)

## [0.9.6] - March 11, 2019:

* Fix whitespace issue. ([#59](https://github.com/Sub6Resources/flutter_html_2/issues/59))

## [0.9.5] - March 11, 2019:

* Add support for `span` in `RichText` parser. ([#61](https://github.com/Sub6Resources/flutter_html_2/issues/61))
* Adds `linkStyle` attribute. ([#70](https://github.com/Sub6Resources/flutter_html_2/pull/70))
* Adds tests for `header`, `hr`, and `i` ([#62](https://github.com/Sub6Resources/flutter_html_2/issues/62))

## [0.9.4] - February 5, 2019:

* Fixes `table` error in `RichText` parser. ([#58](https://github.com/Sub6Resources/flutter_html_2/issues/58))
...
* Adds full support for `sub` and `sup`. ([#46](https://github.com/Sub6Resources/flutter_html_2/pull/46))
* Fixes weak warning caught by Pub analysis ([#54](https://github.com/Sub6Resources/flutter_html_2/issues/54))

## [0.9.0] - January 31, 2019:

* Adds an alternate `RichText` parser and `useRichText` parameter. ([#37](https://github.com/Sub6Resources/flutter_html_2/pull/37))
...
* Fixes issue with text nodes that contain only a space. ([#24](https://github.com/Sub6Resources/flutter_html_2/issues/24))
...
* Fixed issue with table rows not lining up correctly ([#4](https://github.com/Sub6Resources/flutter_html_2/issues/4))
...
* Fixed [#7](https://github.com/Sub6Resources/flutter_html_2/issues/7), [#9](https://github.com/Sub6Resources/flutter_html_2/issues/9), [#10](https://github.com/Sub6Resources/flutter_html_2/issues/10), and [#11](https://github.com/Sub6Resources/flutter_html_2/issues/11).

## [0.4.1] - August 15, 2018:

* Fixed issue with images not loading when inside of `p` tag ([#6](https://github.com/Sub6Resources/flutter_html_2/issues/6))
