library flutter_html_2;

import 'package:flutter/material.dart';
import 'package:flutter_html_2/src/html_parser.dart';
import 'package:flutter_html_2/src/extension/html_extension.dart';
import 'package:flutter_html_2/src/style.dart';
import 'package:html/dom.dart' as dom;

//export render context api
export 'package:flutter_html_2/src/html_parser.dart';
//export src for advanced custom render uses (e.g. casting context.tree)
export 'package:flutter_html_2/src/anchor.dart';
export 'package:flutter_html_2/src/tree/interactable_element.dart';
export 'package:flutter_html_2/src/tree/replaced_element.dart';
export 'package:flutter_html_2/src/tree/styled_element.dart';
//export css_box_widget for use in extensions.
export 'package:flutter_html_2/src/css_box_widget.dart';
//export style api
export 'package:flutter_html_2/src/style.dart';
//export extension api
export 'package:flutter_html_2/src/extension/html_extension.dart';
...
class Html extends StatefulWidget {
  ...
  ///
  /// **extensions** A list of [Extension]s that add additional capabilities to flutter_html_2
  ...
  /// See [its wiki page](https://github.com/Sub6Resources/flutter_html_2/wiki/Style) for more info.
  Html({
    super.key,
    GlobalKey? anchorKey,
    required this.data,
  ...
  /// A list of [HtmlExtension]s that add additional capabilities to flutter_html_2
