...
[![MIT License](https://img.shields.io/badge/license-MIT-blue.svg?style=flat)](https://github.com/hamzasidd3634/flutter_html/blob/master/LICENSE)
...
- [Supported HTML Tags](https://github.com/hamzasidd3634/flutter_html/wiki/Supported-HTML-Elements)

- [Supported CSS Attributes](https://github.com/hamzasidd3634/flutter_html/wiki/Supported-CSS-Attributes)
...
- [Example](https://github.com/hamzasidd3634/flutter_html)
...
[3.0.0 Migration Guide](https://github.com/hamzasidd3634/flutter_html/wiki/Migration-Guides#300)

## API Reference:

For the full API reference, see [here](https://pub.dev/documentation/flutter_html/latest/).

For a full example, see [here](https://github.com/hamzasidd3634/flutter_html/tree/master/example).
...
More examples and in-depth details are available:
 ...
 - [Style](https://github.com/hamzasidd3634/flutter_html/wiki/How-To-Use-Style).
 - [HtmlExtension](https://github.com/hamzasidd3634/flutter_html/wiki/How-To-Use-Extensions)
...
Because this package is parsing MathML to Tex, it may not support some functionalities. The current list of supported tags can be found [on the Wiki](https://github.com/hamzasidd3634/flutter_html/wiki/First-Party-Extensions#flutter_html_math), but some of these only have partial support at the moment.
