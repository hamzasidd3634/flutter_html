# flutter_html_2
[![pub package](https://img.shields.io/pub/v/flutter_html_2.svg)](https://pub.dev/packages/flutter_html_2)
[![codecov](https://codecov.io/gh/Sub6Resources/flutter_html_2/branch/master/graph/badge.svg)](https://codecov.io/gh/Sub6Resources/flutter_html_2)
[![CircleCI](https://circleci.com/gh/Sub6Resources/flutter_html_2.svg?style=svg)](https://circleci.com/gh/Sub6Resources/flutter_html_2)
[![MIT License](https://img.shields.io/badge/license-MIT-blue.svg?style=flat)](https://github.com/Sub6Resources/flutter_html_2/blob/master/LICENSE)
...
Widget build(context) {
  return Html(
    data: """
        <h1>Hello, World!</h1>
        <p><span style="font-style:italic;">flutter_html_2</span> supports a variety of HTML and CSS tags and attributes.</p>
...
<img src="https://raw.githubusercontent.com/Sub6Resources/flutter_html_2/master/example/screenshots/flutter_html_2_readme_screenshot.png" alt="A screenshot showing the above code snippet rendered using flutter_html_2" />

## Table of Contents:

- [Supported HTML Tags](https://github.com/Sub6Resources/flutter_html_2/wiki/Supported-HTML-Elements)

- [Supported CSS Attributes](https://github.com/Sub6Resources/flutter_html_2/wiki/Supported-CSS-Attributes)

- [Why flutter_html_2?](#why-this-package)
...
- [External Packages](#external-packages)
  ...
  - [`flutter_html_2_all`](#flutter_html_2_all)
  
  - [`flutter_html_2_audio`](#flutter_html_2_audio)
  
  - [`flutter_html_2_iframe`](#flutter_html_2_iframe)
  
  - [`flutter_html_2_math`](#flutter_html_2_math)
  
  - [`flutter_html_2_svg`](#flutter_html_2_svg)
  
  - [`flutter_html_2_table`](#flutter_html_2_table)

  - [`flutter_html_2_video`](#flutter_html_2_video)
...
[3.0.0 Migration Guide](https://github.com/Sub6Resources/flutter_html_2/wiki/Migration-Guides#300)

## API Reference:

For the full API reference, see [here](https://pub.dev/documentation/flutter_html_2/latest/).

For a full example, see [here](https://github.com/Sub6Resources/flutter_html_2/tree/master/example).
...
More examples and in-depth details are available:
 ...
 - [Style](https://github.com/Sub6Resources/flutter_html_2/wiki/How-To-Use-Style).
 - [HtmlExtension](https://github.com/Sub6Resources/flutter_html_2/wiki/How-To-Use-Extensions)
...
Add the dependency to your pubspec.yaml:
    ...
    flutter pub add flutter_html_2_audio

```dart
import 'package:flutter_html_2_audio/flutter_html_2_audio';
...
Add the dependency to your pubspec.yaml:
    ...
    flutter pub add flutter_html_2_iframe

```dart
import 'package:flutter_html_2_iframe/flutter_html_2_iframe';
...
Because this package is parsing MathML to Tex, it may not support some functionalities. The current list of supported tags can be found [on the Wiki](https://github.com/Sub6Resources/flutter_html_2/wiki/First-Party-Extensions#flutter_html_2_math), but some of these only have partial support at the moment.

#### Adding the `MathHtmlExtension`:

Add the dependency to your pubspec.yaml:

    flutter pub add flutter_html_2_math

```dart
import 'package:flutter_html_2_math/flutter_html_2_math';
...
Add the dependency to your pubspec.yaml:
    ...
    flutter pub add flutter_html_2_svg

```dart
import 'package:flutter_html_2_svg/flutter_html_2_svg';
...
Add the dependency to your pubspec.yaml:
    ...
    flutter pub add flutter_html_2_table

```dart
import 'package:flutter_html_2_table/flutter_html_2_table';
...
Add the dependency to your pubspec.yaml:
    ...
    flutter pub add flutter_html_2_video

```dart
import 'package:flutter_html_2_video/flutter_html_2_video';
...
<table>
<tr>
<td><img src="https://raw.githubusercontent.com/Sub6Resources/flutter_html_2/master/example/screenshots/flutter_html_2_screenshot.png" alt="A screenshot showing the result of running the example" /></td>
<td><img src="https://raw.githubusercontent.com/Sub6Resources/flutter_html_2/master/example/screenshots/flutter_html_2_screenshot1.png" alt="A second screenshot showing the result of running the example" /></td>
<td><img src="https://raw.githubusercontent.com/Sub6Resources/flutter_html_2/master/example/screenshots/flutter_html_2_screenshot2.png" alt="A third screenshot showing the result of running the example" /></td>
<td><img src="https://raw.githubusercontent.com/Sub6Resources/flutter_html_2/master/example/screenshots/flutter_html_2_screenshot3.png" alt="A fourth screenshot showing the result of running the example" /></td>
</tr>
</table>
